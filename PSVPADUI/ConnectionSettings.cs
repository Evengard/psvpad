...
namespace PSVPAD
{
    public partial class ConnectionSettings : Panel
    {
        public ConnectionSettings()
        {
			...
			this.DisconnectBtn.ButtonAction += disconnectBtn_Pressed;
		...
		private void disconnectBtn_Pressed(Object sender, TouchEventArgs Args){
			AppMain.psvPad.disconnectFromServer();
		}
